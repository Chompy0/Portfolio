<template>
  <nav class="bg-neutral-primary fixed w-full z-20 top-0 start-0  border-default">
    <div class="flex flex-row justify-evenly py-2 bg-gradient-to-b from-purple-900 to-gray-900">
      <a
        v-for="link in links"
        :key="link.text"
        :href="link.url"
        >
        <button class="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-heading rounded-base group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80">
